...
.. code-block:: php
    ...
    <?php
    /**
     * @orm\ManyToOne(targetEntity="Cart", cascade={"all"}, fetch="EAGER")
     */
    private $cart;
...
.. code-block:: php
    ...
    <?php
    /**
     * @orm\OneToMany(targetEntity="Phonenumber", mappedBy="user", cascade={"persist", "remove", "merge"}, orphanRemoval=true)
     */
    public $phonenumbers;
